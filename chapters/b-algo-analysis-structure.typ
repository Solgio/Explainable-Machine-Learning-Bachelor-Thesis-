...
+ #strong[@computational_complexity:long]: analysis of the computational requirements of each algorithm, including time complexity and scalability regarding both training and inference.
...
+ #strong[Predictive performance and limitations]: evaluation of the predictive performance of each algorithm on relevant datasets, considering the data assumptions and mathematical foundations of the models.

+ #strong[Metrics for prediction quality]: presentation of the most relevant metrics for evaluating the model's performance, based on the task.

+ #strong[Interpretability and explainability metrics]: presentation of the most relevant metrics for evaluating the models' interpretability and explainability, based on the task.

+ #strong[Interpretability and explainability limitations]: discussion of the limitations of both the intrinsic interpretability of the models and the post-hoc explainability techniques applied to them.