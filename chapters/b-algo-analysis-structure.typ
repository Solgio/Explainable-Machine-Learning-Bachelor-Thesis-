...
#v(1em)
The analysis of the algorithms is structured in a systematic way ensuring a systematic evaluation of their interpretability and functioning. The structure includes the following components:
