...
The zero-shot prompting also revealed to be quite effective with some additional techniques such as the use of #link(<cap:chain-of-thought>)[Chain of Thought] (CoT) prompting @llms-zero-shot.

=== Multimodal prompt
<cap:multimodal-prompt>
